...
const products = [
  {
    ...
    image:
      "https://media.istockphoto.com/id/1473867574/photo/online-buying-and-delivery-red-shopping-basket-with-fresh-food.jpg?s=612x612&w=0&k=20&c=1k2OwkB47ZA3n3D-u_kx2yeo61vvtzMjt0MwvEkLzZA=",
    price: 50,
...
export default function page() {
  ...
  const data = products.map((product) => (
    <section key={product.id} className="rounded-lg bg-gray-100 p-5 shadow-black">
      ...
      <div>
        <Image src={product.image} alt="new" width={200} height={200} title={`Grab AWOOF ${product.name}`} className="hover:shadow-xl hover:shadow-black" />
      </div>
