...
export default function Cart() {
  ...
  return (
    <div className="bg-gray-100">
      ...
      {cartItems.map((item) => {
        const isFirstInstance = cartItems.findIndex((cartItem) => cartItem.id === item.id) === 0;
        return (
            ...
            <div className="space-x-4 mt-4 flex items-center">
              ...
              {isFirstInstance && (
                <div className="flex flex-col">
                  ...
                  <p className="mt-4 font-bold">{`Price: $${item.price}`}</p>
                </div>
              )}
              <div>
      ...
      {showItemAdded && <div className="item-added-message">Item Added</div>}
    </div>
  );
}
